...
int main()
{
	BoundingSphere sph1(Vector3f(0,0,0), 1.0f);
	BoundingSphere sph2(Vector3f(0,0,1.5f), 1.0f);
	IntersectData data = sph1.IntersectBoundingSphere(sph2);
	std::cout << "Does Intersect: " << data.getDoesIntersect() << std::endl;
	std::cout << "Distance: " << data.getDistance() << std::endl;
